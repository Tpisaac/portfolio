          ...
          {isOpen && (
            ...
            >
              <p className=" dark:text-gray-900 raleway">
                This is a fully responsive Shopping-Cart page which also icludes
                a Checkout page. Built with React.js, CSS/Tailwind.
              </p>
              <p className=" dark:text-gray-900 raleway">
                The buttons below are snippets from the codebase that
                showcase some of the core functionality implemented in the
                project.
              </p>
